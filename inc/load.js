...
//');
$("body").append('\
  <div class="ds-thread" data-thread-key="'+(window.location.href.split("/")[3].substr(0, window.location.href.split("/")[3].indexOf('.html')) || 'index')+'" data-title="'+(window.document.title.substr(0, window.document.title.indexOf(' - Kirin\'s Blog')) || 'Kirin\'s Blog')+'" data-url="'+window.location.href+'"></div>\
');
$("body").append('\
